...
class Mongodb(object):
    ...
    def get(self, condition, kwargs=None, spec_sort=None):
        ...
        :param kwargs: dict, retain fields what you want to
        :param spec_sort: tuple, sorting according to which fields
        """
        if not isinstance(condition, dict):
    ...
    def insert(self, data, batch=None):
        ...
        data: eg, {...}, or [{...}, {...}, ...]
        :param data: dict
        :param batch: list or tuple of dict item
        """
        if self.__conn is None:
            self.__connect()
    ...
    def update(self, condition, setdata=None, unset_keys=None):
        ...
        :param condition: dict, query condition
        :param setdata: dict
        :param unset_keys: list or tuple, None value
        """
        if not isinstance(condition, dict):
